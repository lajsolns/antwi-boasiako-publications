          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-12">
            ...
            <div className="lg:col-span-1">
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                {event.type === 'upcoming' && (
                  <button className="w-full mt-6 px-4 py-3 bg-blue-800 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 font-inter text-sm font-medium">
                    Register Now
                  </button>
                )}
            ...
            {activeTab === 'overview' && (
              <div className="prose prose-lg max-w-none">
                ...
                <ul className="list-disc pl-6 space-y-2 mb-6">
                  <li className="font-inter text-gray-700">Ghana's cybersecurity evolution</li>
                  <li className="font-inter text-gray-700">Digital transformation in Africa</li>
                  <li className="font-inter text-gray-700">Best practices for national security</li>
                      ...
                      <div key={video.id} className="bg-gray-50 rounded-lg overflow-hidden">
                        <div className="relative h-32 bg-gray-200">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center">
                            <button className="w-12 h-12 bg-blue-800 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors duration-200">
                ...
                {event.gallery.length > 4 && (
                  <div className="text-center">
                    <button
                      ...
                      className="inline-flex items-center px-6 py-3 bg-blue-800 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 font-inter text-sm font-medium"
                    >
