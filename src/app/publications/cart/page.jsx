                ...
                <div className="max-w-6xl mx-auto relative z-10">
                    ...
                    {!cartItems || cartItems.length === 0 ? (
                        <div className="bg-white p-12 border border-gray-100 shadow-xl shadow-gray-100/50 text-center relative overflow-hidden">
                            ...
                            <h2 className="font-playfair text-2xl text-gray-900 mb-4">Your bag is currently empty</h2>
                            <p className="font-inter text-gray-500 mb-10 max-w-md mx-auto font-light leading-relaxed">
                                Explore our collection of intellectual publications and add them to your selection for purchase.
                            </p>
                            <Link
                                href="/publications/all-books"
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
                                            ...
                                            >
                                                <div className="relative w-full sm:w-32 h-44 bg-gray-50 border border-gray-100 flex-shrink-0 group overflow-hidden">
                                                    {item.image ? (
                                                        ...
                                                        <div className="w-full h-full flex items-center justify-center">
                                                            <span className="text-gray-300 text-[10px] uppercase tracking-widest">No Image</span>
                                                        </div>
                                                    )}
                                                </div>
                                                ...
                                                <div className="flex-1 flex flex-col justify-between">
                                                    <div className="space-y-2">
                                                        <h3 className="font-playfair text-2xl text-gray-900 leading-snug">
                                                            {item.title}
                                                        </h3>
                                                        <p className="font-inter text-sm text-gray-400 font-light flex items-center uppercase tracking-widest">
                                                            Price: <span className="ml-2 text-amber-800 font-medium">{isLocationLoading ? '...' : getPriceDisplay(item)}</span>
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div className="flex items-center justify-between mt-8">
                                                        <div className="flex items-center border border-gray-100 bg-white">
                                                            ...
                                                            <span className="font-inter text-sm text-gray-600 w-12 text-center border-x border-gray-50">
                                                                {item.quantity}
                                                            </span>
                                                            <button
                            ...
                            <div className="lg:col-span-1">
                                <div className="bg-white p-10 border border-gray-100 shadow-xl shadow-gray-100/50 sticky top-40 relative overflow-hidden">
                                    ...
                                    <h2 className="font-playfair text-2xl text-gray-900 mb-8 pb-4 border-b border-gray-50">Order Summary</h2>

                                    <div className="space-y-6 mb-10">
                                        <div className="flex justify-between items-center text-sm font-inter tracking-wide">
                                            <span className="text-gray-400 uppercase text-[10px] tracking-[0.2em]">Subtotal</span>
                                        ...
                                        <div className="flex justify-between items-center text-sm font-inter tracking-wide font-light">
                                            <span className="text-gray-400 uppercase text-[10px] tracking-[0.2em]">Shipping</span>
                                        ...
                                        <div className="pt-6 border-t border-gray-100 flex justify-between items-baseline">
                                            <span className="font-inter text-xs tracking-widest uppercase text-gray-900 font-bold">Estimated Total</span>
...
// Helper for currency formatting if needed in summary
