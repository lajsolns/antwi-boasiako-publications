...
import Book1 from "../../../../public/image/books/the_republic.png";
import Book2 from "../../../../public/image/books/the_republic.png";
...
const bookData = {
  ...
  subTitle2: "",
  desc: `THE REPUBLIC offers a rare, behind-the-scenes look at Ghana’s cybersecurity development — from the early formative days to a decade of global recognition. Through vivid storytelling and authentic documentation, it traces how a shared national vision, led by committed individuals across government, public service, industry, and international partnerships, built one of Africa’s most respected cybersecurity ecosystems. `,
...
const BookDetailPage = () => {
  ...
  const handleShare = (platform) => {
    const text = `Check out "${bookData.title}" by Dr. Albert Antwi-Boasiako`;
